...
(1, 'Preparar apresentação', DATE '2025-11-10', FALSE, 'PRE_REUNIAO', 'ALTA', 1, 1),
(2, 'Coletar métricas', DATE '2025-11-12', FALSE, 'PRE_REUNIAO', 'MÉDIA', 3, 2),
(3, 'Fechar ata e enviar', DATE '2025-11-09', TRUE, 'POS_REUNIAO', 'BAIXA', 2, 3);
