                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                                    {initialValue ? 'Atualize os detalhes abaixo' : 'Defina o identificador da regra'}
                                </p>
                            </div>
                        </div>
                        <button
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-6">
                        <div>
                            <label className="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-2">
                                Chave da Permissão <span className="text-red-500">*</span>
                            </label>
                            <div className="relative">
                                <input
                                    ...
                                    className={`w-full px-4 py-2.5 bg-white dark:bg-slate-900 border rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none font-mono text-sm ${error
                            ...
                            {error ? (
                                ...
                                <p className="mt-2 text-xs text-slate-500 dark:text-slate-400">
                                    Recomendado usar letras maiúsculas e underscores (snake_case).
                                </p>
                            )}
                        </div>
                        ...
                        <div className="flex gap-3 pt-2">
                            ...
                            >
                                ...
                                {isLoading ? 'Salvando...' : 'Salvar Permissão'}
                            </button>
                        </div>
                    </form>
                </div>
