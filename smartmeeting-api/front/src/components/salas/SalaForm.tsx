                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors.capacidade ? 'border-red-300' : 'border-gray-300'
                                        }`}
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors.localizacao ? 'border-red-300' : 'border-gray-300'
                                        }`}
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors.categoria ? 'border-red-300' : 'border-gray-300'
                                        }`}
                                >
