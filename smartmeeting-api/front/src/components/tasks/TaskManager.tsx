...
import { PageHeader, PageHeaderTab } from '../../components/common/PageHeader';
            ...
            <PageHeader
                ...
                actions={
                    <div className="flex items-center gap-3">
                        <button className="relative p-2 bg-white dark:bg-mono-700 text-mono-700 dark:text-mono-300 hover:bg-mono-50 dark:hover:bg-mono-600 shadow-sm rounded-lg transition-colors">
                        ...
                        <button className="p-2 bg-white dark:bg-mono-700 text-mono-700 dark:text-mono-300 hover:bg-mono-50 dark:hover:bg-mono-600 shadow-sm rounded-lg transition-colors">
